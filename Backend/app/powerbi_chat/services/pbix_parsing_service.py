        ...
        try:
            ...
            for table_name in table_names:
                ...
                try:
                            ...
                            table_columns.append(
                                {
                                    ...
                                    "ColumnName": col_name,
                                    "DataType": str(table_data[col_name].dtype)
                    ...
                    logger.warning(
                        f"Could not extract columns from table '{table_name}': {str(e)}"
                    )
    ...
    def _transform_to_structured_metadata(raw_data: Dict[str, Any]) -> Dict[str, Any]:
            ...
            if isinstance(col_data, dict):
                ...
                if table_name and col_name:
                    ...
                    if found_table:
                        ...
                        is_hidden = col_data.get(
                            "IsHidden", col_data.get("Is Hidden", False)
                        )
                ...
                if measure_name:
                    ...
                    if found_table:
                        ...
                        measure_info = {
                            ...
                            "isHidden": measure_data.get(
                                "IsHidden", measure_data.get("Is Hidden", False)
                            ),
                            "table": found_table,
                        }
        ...
        for pq in raw_data.get("power_query", []):
            ...
            if isinstance(pq, dict):
                ...
                key_transformations = PBIXParsingService._extract_key_transformations(
                    m_code
                )
    ...
    def _chunk_metadata(metadata: Dict[str, Any]) -> List[Document]:
        ...
        for i, visual in enumerate(visuals, 1):
            ...
            for table in data_sources:
                ...
                table_visual_map[table].append(
                    {"index": i, "type": visual_type, "page": page_name}
                )
        ...
        for table_name, visual_refs in table_visual_map.items():
            ...
            for ref in visual_refs:
                ...
                cross_ref_doc += (
                    f"- Visual {ref['index']} ({ref['type']}) on page {ref['page']}\n"
                )
    ...
    def _extract_key_transformations(m_code: str) -> List[str]:
        ...
        try:
            ...
            if "table." in m_code_lower:
                ...
                transformations.append(
                    "Table Operations: Multiple table transformations"
                )
            ...
            logger.warning(
                f"Error extracting key transformations from M code: {str(e)}"
            )
